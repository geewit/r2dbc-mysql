...
final class SimpleTransactionDefinition implements MySqlTransactionDefinition {
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof SimpleTransactionDefinition that) {
    ...
    private static SimpleTransactionDefinition of(Map<Option<?>, Object> options) {
        return switch (options.size()) {
            ...
            case 1 -> {
                ...
                yield new SimpleTransactionDefinition(Collections.singletonMap(e.getKey(), e.getValue()));
            }
            default -> new SimpleTransactionDefinition(options);
        };
    }
}
