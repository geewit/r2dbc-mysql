...
import io.geewit.persistence.r2dbc.mysql.api.MySqlConnectionMetadata;
...
final class MySqlSimpleConnection implements MySqlConnection {
    ...
    MySqlSimpleConnection(Client client,
                          Codecs codecs,
                          QueryCache queryCache,
                          Predicate<String> prepare) {
    ...
    public Mono<Void> close() {
        ...
        if (logger.isDebugEnabled()) {
            return closer.doOnSubscribe(_ -> logger.debug("Connection closing"))
